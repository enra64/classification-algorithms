...
\begin{frame}
    ...
    \begin{itemize}
        \item Kombinatorischer Ansatz
        \begin{itemize}
            \item Genereller Ansatz: Kompletter L\"osungsbaum
            \item Recht aufw\"andig: $O(2^n)$
        \end{itemize}
        \item Kontinuierlicher Ansatz
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{Kontinuierlicher Ansatz}
    \begin{itemize}
        \item Quasi-Newton Ann\"aherung
        \begin{itemize}
            \item Ersetzen der Loss-Funktionen durch ableitbare
